...
async function main(hackatomWasmPath) {
    ...
    const uploadFee = calculateFee(1500000, gasPrice);
    ...
    const { contractAddress } = await client.instantiate(alice.address0, uploadReceipt.codeId, msg, "My instance", instantiateFee, { memo: `Create a hackatom instance` });
